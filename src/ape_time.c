...
APE_API void ape_time_setup( lua_State* L ) {
  luaL_Reg const ape_time_metamethods[] = {
    { "__eq", ape_time_eq },
    { "__lt", ape_time_lt },
    { "__add", ape_time_add },
    { "__sub", ape_time_sub },
  ...
  /***
    ...
    @type apr_time_t
  */
  luaL_Reg const ape_time_methods[] = {
  /***
  ...
  */
  ...
  moon_object_type const ape_time_type = {
    APE_TIME_NAME,
    sizeof( apr_time_t ),
  ...
  /***
    ...
    @section time
  */
  luaL_Reg const ape_time_functions[] = {
  /***
  ...
  */
  ...
  moon_defobject( L, &ape_time_type, 0 );
  moon_register( L, ape_time_functions );
}


APE_API void ape_time_userdata( lua_State* L, apr_time_t time ) {
  apr_time_t* newtime = moon_newobject( L, APE_TIME_NAME, 0 );
  *newtime = time;
}
